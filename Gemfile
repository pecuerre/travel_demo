...
gem 'spree_travel_package', path: '../openjaf/spree_travel_package'
gem 'spree_travel_sample', path: '../openjaf/spree_travel_sample'
gem 'spree_property_type', path: '../openjaf/spree_property_type'
