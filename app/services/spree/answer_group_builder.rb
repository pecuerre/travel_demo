module Spree
  class AnswerGroupBuilder < Spree::BaseService
    ...
    def save!(options = {})
      ...
      if options[:measurement_set].present?
        @answer_group.measurement_set = options[:measurement_set]
      end
    ...
    def build_answer_group
      @answer_group = Spree::AnswerGroup.new(user: user, question_group: question_group)
      @answers = @question_group.questions.collect do |question|
