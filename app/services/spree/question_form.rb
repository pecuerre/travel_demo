module Spree
  class QuestionForm < Spree::BaseService
    AVAILABLE_QUESTIONS =
      [
       Spree::Questions::Checkbox,
       Spree::Questions::Date,
       Spree::Questions::Long,
       Spree::Questions::Numeric,
       Spree::Questions::Radio,
       Spree::Questions::Select,
       Spree::Questions::Short,
      ]
