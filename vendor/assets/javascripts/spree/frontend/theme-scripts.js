...
function changeTraveloElementUI() {
    ...
    tjq('.datepicker-wrap input').each(function() {
        ...
        tjq(this).datepicker({
            showOn: 'button',
            buttonImage: image_url('icon/blank'),
            buttonText: '',
...
tjq(window).load(function() {
    ...
    if (enableChaser == 1 && tjq('#content').length > 0 && tjq('#main-menu ul.menu').length > 0) {
        ...
        tjq('<h1 class="logo navbar-brand"><a title="Travelo - home" href="index.html"><img alt="" src="'+ image_url('logo') +'"></a></h1>').insertBefore('.chaser .menu');
