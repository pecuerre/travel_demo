module Sample
  ...
  class Tour
    ...
    @tours_names=['Carnival', 'Royal Caribean', 'Mediterranean trip', 'Big Ilands', 'Caribean Rinmbows', 'Horizon Colors', 'Summer trip', 'Great Caribbean and antilles']
    ...
    class << self
      ...
      def generate_tour
        c = OpenStruct.new
        c.tour_name=@tours_names.sample
        c.days=rand(3...7)
        c.tour_length="#{c.days} nights"
